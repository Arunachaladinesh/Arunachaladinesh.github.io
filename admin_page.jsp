...
String query="SELECT *,(select id from products where idproducts=o.idproducts limit 1) as idfarmer FROM `orders` o  order by isdelivered asc";
...
while(rt.next()){
            ...
            <tr style="height: 30px;font-size: 18px;">
                ...
                <td><%=rt.getString("idfarmer")%></td>
                <td><%=rt.getString("isconfirmed")%> </td>
                <td>
                    <%=rt.getString("isdelivered")%>&nbsp;&nbsp;&nbsp;&nbsp;<br><a href="make_delivered.jsp?<%=rt.getString("idorders")%>">Make Delivered by</a> <br>
                    <select>
                        <option >Person1</option>
                        <option >Person2</option>
                        <option >Person3</option>
                        <option >Person4</option>
                        <option >Person5</option>
                    </select>
                </td>
            </tr>
            <%
